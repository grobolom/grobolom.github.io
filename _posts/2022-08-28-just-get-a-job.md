...
In recent years I've seen many tweets like this one:
...
Based on the [Rutgers tuition estimates](https://admissions.rutgers.edu/costs-and-aid/tuition-fees), the average in-state student needs to pay $30,172 per academic year. Note that this does not include rent / food / etc. for the summer (mid-May until September, ~3 and a half months) or the winter break (short, usually only a few weeks).
...
[According to Indeed.com](https://www.indeed.com/career/barista/salaries/NJ), the average pay for a Barista in NJ is $10.88 / hour. Let's be generous and round up to $12.00 / hour, which is realistically the most a student would be able to find. Now, again, anecdotally, most baristas do not work a full 40 hours / week. This is quite often the case for students, as they will often not have the necessary availability to cover the full 40 hours. There is plenty of evidence that baristas (and other, similar workers) receive less than 40 hours a week, on top of dealing with extremely inconsistent schedules and stressful work conditions. However, let's assume that, at the very least, each worker will receive 32 hours of work a week for their weeks of employment.
